                ...
                <div id = "wearing-part-content" className = "wearing-part-content">
                    ...
                    <div className = "inside-pull-down">
                        ...
                        <div id = "luntai-div" className = "inside-pull-down-content">
                            ...
                            <p>
                            &emsp;&emsp;&emsp;划重点，轮胎非常重要！轮胎作为车子与地面唯一接触的表面，直接影响着在赛道上的抓地力，更加抓地的轮胎对于圈速的提升是非常明显且直接的，pss和cup2在一条两分钟左右的赛道圈速可以差大约5秒。刚开始参加赛道日，前三到五次可以仍旧使用原厂轮胎，因为最开始需要练习的是走线，在直道不用全油门的情况下先寻找一个大致的刹车点，同时弯速不那么快的话一般原厂轮胎是够用可以走对行车线的。对赛道更加熟悉或者有更多模拟器经验的就可以在两三个赛道日之后更换半热熔轮胎。固然半热熔轮胎可以提供更好的抓地力提升圈速，但是圈速更快也意味着会有更高的可能性犯错以及更加严重的代价，更加要去训练赛道技巧。
                            </p>

                            <p>
                            &emsp;&emsp;&emsp;接下来正式具体讲解半热熔轮胎，还是先提醒不要去盲目更换半热熔轮胎，因为这些轮胎目的是在干地发挥最大的抓地力，那么相比于日常使用的街胎来说，雨天的抓地力会差非常多，所以下雨天一定不要开快！相信大家会接触到很多资料说换上了xx半热熔轮胎，可是中文里对半热熔的定义太过于宽泛了，半热熔轮胎总的来说是含有一种特殊橡胶可以更加抓地的轮胎。同时又为了满足赛道人群用这台车的一部分代步需求，诞生了一类半R胎。比半R性能更好比半热熔差一点的，同时更加不耐磨一点的叫做R胎。Cup 2就是R胎很多人用它代步事实上消耗会很快，街胎用到ps4s就够了。半R胎其实用英文就非常好理解是Extreme Performance Summer tire, 而R胎叫做R compound tire。以下是我搜集的一部分半R胎，R胎和半光头胎的资料，在这里就给大家做一个参考，这三种轮胎的分类主要是200TW和100TW为界。
                            </p>

                            <p>
                            &emsp;&emsp;&emsp;更好的轮胎代表着更强的抓地力，但同时对悬挂的要求也就更高。绝大部分改装车的原厂悬挂都没有能力发挥100TW及以下的轮胎抓地力，因此没有更换绞牙避震的大部分车友们其实更换一套半R胎就够了,最多可以用到Cup 2,半R胎和Cup2还可以平时走街开到赛道，剩下的轮胎几乎不能代步了，最好是到赛道再换上。
                            </p>


                            <p>
                            &emsp;&emsp;&emsp;最后提一下轮胎的损耗，不同于街胎，半热熔轮胎都是用heat cycle进行计算的，heat cycle指轮胎达到一个稳定的工作温度之后一段时间又冷却下来。赛道日基本以一节15分钟为计算是一个heat cycle，那么轮胎大致可以使用30个heat cycle，以赛道日来计算的话约等于6个赛道日吧，不过具体情况还是要看驾驶的激烈程度以及轮胎花纹的磨损。以Cup2为例，假如还日常行驶的话大概率在heat cycle用完之前就磨完了胎纹，大致使用是1w mile道路驾驶以及6次赛道日。
                            </p>
                    ...
                    <div className = "inside-pull-down">
                        ...
                        <div id = "shache-div" className = "inside-pull-down-content">
                            ...
                            <PullDownMenu
                                ...
                                content1 = {"\t碳陶瓷盘在赛道上高温情况下会直接气化，消耗特别快，当然刹车力度永远保持一致，但是一套一万多美金，除了贵没有任何缺点。民用赛道日基本都是选择钢盘，升级的话只选择划线盘，因为打孔盘的孔可能在激烈工况下裂开，那么这个盘就不能用了，在赛道上裂开的话甚至可能会造成极大危险。划线盘中更好的选择是浮动盘，可以很好的解决散热提供稳定的摩擦力。强力推荐性价比极高的girodisc，不差钱可以选Ap J hook。"}
